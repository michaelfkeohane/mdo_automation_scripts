...
VPN_NO = "500"
VPN_FT_NAME = ('IntersiteVN_VPN_Template4321')
VPN_INT_FT_NAME = ('IntersiteVN_VPN_Interface_Template4321')
BGP_FT_NAME = ('IntersiteVN_BGP_VPN_Template4321')
...
urllib.request.urlretrieve ("http://10.85.189.49/demo/4321_default_dt.json", "4321_default_dt.json")
...
print ('Cleaning ISR4321')
default_dt(isr4321, "4321")
time.sleep(50)
delete_ft()
