...
VPN_NO = sys.argv[1]
VPN_TEMPLATE_NAME = ('VPN' + VPN_NO + 'Template')
VPN_INT_TEMPLATE_NAME = ('VPN' + VPN_NO + 'Interface_Template')
BGP_TEMPLATE_NAME = ('BGP_VPN_' + VPN_NO + 'Template')
BGP_LOCAL_IP = sys.argv[2]
BGP_NEIGHBOR_IP = sys.argv[3]
...
print ('Configuring ISR4321')
phase1 = create_dt(isr4321, "4321")
print (phase1)
time.sleep(60)
print ('Configuring ISR4451')
phase2 = create_dt(isr4451, "4451")
print (phase2)
